...
1) **System Interface Requirement**
     ...
     **1. Install the android app and select image from gallery.** 
     ![1. Install the android app and select image from gallery.](https://github.com/loveleen-amar/LTTS-SDLC-UNIT/blob/main/1_Requirements/1.JPG){:height="40px" width="400px"}
